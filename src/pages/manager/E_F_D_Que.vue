    ...
    <div-flex-column class="page">
      <div-flex-column>
        <div-flex-column class="card head">
          <div-flex-row>
            <div>共 {{count}} 条&nbsp;&nbsp;<span class="strong">E、F、D 考试</span>&nbsp;&nbsp;题目</div>
          </div-flex-row>
        </div-flex-column>
      </div-flex-column>
...
<script>
  export default {
    ...
    methods: {
      clickToAdd: function () {
        this.$router.push("/manager/index/editque?type=E_F_D&level="+this.searchLevel);
      },
      ...
      clickEdit: function (data) {
        this.$router.push("/manager/index/editque?id="+data.id+"&type=E_F_D&level="+this.searchLevel);
      },
