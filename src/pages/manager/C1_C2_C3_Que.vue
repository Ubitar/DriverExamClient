    ...
    <div-flex-column class="page">
      <div-flex-column>
        <div-flex-column class="card head">
          <div-flex-row>
            <div>共 {{count}} 条&nbsp;&nbsp;<span class="strong">C1、C2、C3 考试</span>&nbsp;&nbsp;题目</div>
          </div-flex-row>
        </div-flex-column>
      </div-flex-column>
...
<script>
  export default {
    ...
    methods: {
      clickToAdd: function () {
        this.$router.push("/manager/index/editque?type=C1_C2_C3&level="+this.searchLevel);
      },
      ...
      clickEdit: function (data) {
        this.$router.push("/manager/index/editque?id="+data.id+"&type=C1_C2_C3&level="+this.searchLevel);
      },
