    ...
    <div-flex-column class="page">
      <div-flex-column>
        <div-flex-column class="card head">
          <div-flex-row>
            <div>共 {{count}} 条&nbsp;&nbsp;<span class="strong">A1、A3、B1 考试</span>&nbsp;&nbsp;题目</div>
          </div-flex-row>
        </div-flex-column>
      </div-flex-column>
...
<script>
  export default {
    ...
    methods: {
      clickToAdd: function () {
        this.$router.push("/manager/index/editque?type=A1_A3_B1&level="+this.searchLevel);
      },
      ...
      clickEdit: function (data) {
        this.$router.push("/manager/index/editque?id="+data.id+"&type=A1_A3_B1&level="+this.searchLevel);
      },
